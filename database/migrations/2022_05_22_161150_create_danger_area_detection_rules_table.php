...
class CreateDangerAreaDetectionRulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('danger_area_detection_rules', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('danger_area_detection_rules');
    }
}
